...
class ErrorCodes:
    ...
    PERM_SSO_REQUIRED = ("PERM_SSO_REQUIRED", status.HTTP_403_FORBIDDEN)  # AUTH-009：强制 SSO 策略拒绝（建会话前）
    SSO_TXN_INVALID = ("SSO_TXN_INVALID", status.HTTP_401_UNAUTHORIZED)  # AUTH-009 附录 B：sso_txn 认领事务失效/超时
...
DEFAULT_MESSAGES: dict[str, str] = {
    ...
    "PERM_SSO_REQUIRED": "该组织已启用强制 SSO 登录",
    "SSO_TXN_INVALID": "登录事务已失效，请重新发起 SSO 登录",
