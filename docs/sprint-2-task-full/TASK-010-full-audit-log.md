...
```
┌──────────────────────────────────────────────────────────────────┐
│ TZXM-13  后端导出 API            [概览] [动态] [评论]              │  ← 笔误（ADR-0013 R1）
├──────────────────────────────────────────────────────────────────┤
│ 今天 · 2026-09-01                              [全部 ▾] [⋯ ▾]    │
│                                                                   │
│  14:32  👤张三                                                    │
...
> **勘误（ADR-0013 R1，2026-09-05）**：上方 mockup 头行的 Tab 条画的是「[概览] [动态] [评论]」三 Tab，系笔误——Drawer Tab 条终态为 C.25（ADR-0011 #1/#20）定稿的四 Tab「描述｜评论｜动态｜附件」，本文升级的「动态」Tab 是其中之一，不新增或更名 Tab。
