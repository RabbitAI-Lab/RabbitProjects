...
| 文档状态 | 待评审（Draft） |
| 最后更新日期 | 2026-09-05（R1 修复 8 项：M5-BOARD、BOARD-003→004→005 依赖链 + 注二、is_locked「P2 已建本迭代开放」、dg §1.3 错位注一、SAML / 多维分组验收条目、Day4 分组交付点、§9 风险 / §10 退出条件补齐；R2 修复：「零新增权限码」改精确口径（新增码收敛于 AUTH-009 附录 B 单点）、§6 第 3 条对齐 AUTH-008、注二补 AUTH-007/008→AUTH-009 边、§4 补 locked_by/locked_at；R3 复评 PASS 10/9.5×4） |
